...
import csv
import numpy as np
with open('class_id_Customized_h15v2.csv') as csvFile:
...
savepath="object365_c15_v2/"#"coco_2017_sub1/"  #保存提取类的路径,我放在同一路径下 #++
labelformat = 'txt'
...
classes_names = ["Chair","Bottle","Cup","Handbag/Satchel","Backpack","Bowl/Basin","Umbrella","Cell Phone","Spoon","Remote","Refrigerator","Microwave","Toothbrush","Desk","Coffee Table","Scissors","Fork"]
# classes_names = ["Bus","Car"]
...
#%% main ------------------------
ALL_classes_names = ["Toothbrush","Bottle","Cup","Handbag/Satchel","Backpack","Bowl/Basin","Umbrella","Cell Phone","Spoon","Remote","Refrigerator","Microwave","Chair","Desk","Coffee Table","Scissors","Fork"]
for classes_names in ALL_classes_names:
#file name 抓取自前面的class_id_Customized_h15v1.csv，避免像是Handbag這類有/影響檔案名

    data_file_name=classes_names.split('/')[0]
